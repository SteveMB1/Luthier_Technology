	...
	$lookups = array(   
		...
		'repairs' => array(   
			'item' => array(
				...
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`inventory`.`id`) || CHAR_LENGTH(`inventory`.`item`), CONCAT_WS(\'\', `inventory`.`id`, \' - \', `inventory`.`item`), \'\')',
				'parent_from' => '`inventory` ',
				'filterers' => array(),
				'custom_query' => '',
		...
		'shipping' => array(   
			'register_id' => array(
				'parent_table' => 'register',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`register`.`id`) || CHAR_LENGTH(`register`.`client_name`), CONCAT_WS(\'\', `register`.`id`, \' - \', `register`.`client_name`), \'\')',
				'parent_from' => '`register` LEFT JOIN `employees` as employees1 ON `employees1`.`id`=`register`.`seller` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => true,
				'list_type' => 0,
			...
			'client_name' => array(
				'parent_table' => 'register',
				'parent_pk_field' => 'id',
				'parent_caption' => '`register`.`client_name`',
				'parent_from' => '`register` LEFT JOIN `employees` as employees1 ON `employees1`.`id`=`register`.`seller` ',
				'filterers' => array(),
				'custom_query' => '',
		...
		'register' => array(   
			'seller' => array(
				...
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`employees`.`first`) || CHAR_LENGTH(`employees`.`last`), CONCAT_WS(\'\', `employees`.`first`, \' \', `employees`.`last`), \'\')',
		...
		'register_items' => array(   
			...
			'cost' => array(
				'parent_table' => 'inventory',
				'parent_pk_field' => 'id',
				'parent_caption' => '`inventory`.`price_high`',
				'parent_from' => '`inventory` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'ref_img' => array(
				'parent_table' => 'inventory',
				'parent_pk_field' => 'id',
				'parent_caption' => '`inventory`.`inventory_photo`',
				'parent_from' => '`inventory` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
