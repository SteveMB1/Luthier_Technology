				...
				<table class="table">
					...
					<tr>
						<td align="center">
							...
							<?php
								$arrFields = array('', 'acquisition', 'inventory', 'repairs', 'shipping', 'register', 'expenses', 'employees', 'register_items');
								$arrFieldCaptions = array('All tables', 'Acquisition', 'Inventory', 'Repairs', 'Shipping', 'Register', 'Expenses', 'Employees', 'Order Items');
