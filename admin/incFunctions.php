<?php
	...
	*/
	...
	function getThumbnailSpecs($tableName, $fieldName, $view){
		if($tableName=='acquisition' && $fieldName=='photo_1' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='acquisition' && $fieldName=='photo_1' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='acquisition' && $fieldName=='photo_2' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='acquisition' && $fieldName=='photo_2' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='acquisition' && $fieldName=='photo_3' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='acquisition' && $fieldName=='photo_3' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='acquisition' && $fieldName=='photo_4' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='acquisition' && $fieldName=='photo_4' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='acquisition' && $fieldName=='photo_5' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='acquisition' && $fieldName=='photo_5' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='acquisition' && $fieldName=='photo_6' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='acquisition' && $fieldName=='photo_6' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='inventory' && $fieldName=='inventory_photo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='inventory' && $fieldName=='inventory_photo' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='repairs' && $fieldName=='photo_1' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='repairs' && $fieldName=='photo_1' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='repairs' && $fieldName=='photo_2' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='repairs' && $fieldName=='photo_2' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='expenses' && $fieldName=='photo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='expenses' && $fieldName=='photo' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		return FALSE;
	}
	########################################################################
	...
	function logOutUser(){
		...
		if(isset($_COOKIE['Luthier_Technologies_rememberMe'])){
			setcookie('Luthier_Technologies_rememberMe', '', time()-42000);
		}
		session_destroy();
	}
	########################################################################
