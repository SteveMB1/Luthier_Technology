<?php
	...
	$p=array(   
		'acquisition' => array(
			'ref_listing' => '',
			'photo_1' => $Translation['ImageFolder'],
			'photo_2' => $Translation['ImageFolder'],
			'photo_3' => $Translation['ImageFolder'],
			'photo_4' => $Translation['ImageFolder'],
			'photo_5' => $Translation['ImageFolder'],
			'photo_6' => $Translation['ImageFolder'],
			'primary key' => 'id'
		),
		'inventory' => array(
			'ref_listing' => '',
			'inventory_photo' => $Translation['ImageFolder'],
			'primary key' => 'id'
		),
		'repairs' => array(
			'photo_1' => $Translation['ImageFolder'],
