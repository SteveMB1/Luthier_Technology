<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'shipping' table. 
	...
	*/
	...
	function shipping_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function shipping_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function shipping_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['register_id'], $data['client_name'], $data['phone'], $data['email'], $data['company'], $data['shipping_gateway'], $data['street_address'], $data['city'], $data['state'], $data['zip'], $data['country'], $data['ship_width'], $data['ship_length'], $data['ship_height'], $data['distance_unit'], $data['ship_weight']
	...
	*/
	...
	function shipping_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['register_id'], $data['client_name'], $data['phone'], $data['email'], $data['company'], $data['shipping_gateway'], $data['street_address'], $data['city'], $data['state'], $data['zip'], $data['country'], $data['ship_width'], $data['ship_length'], $data['ship_height'], $data['distance_unit'], $data['ship_weight'], $data['ship_mass_unit'], $data['tracking_number']
	...
	*/
	...
	function shipping_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function shipping_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['register_id'], $data['client_name'], $data['phone'], $data['email'], $data['company'], $data['shipping_gateway'], $data['street_address'], $data['city'], $data['state'], $data['zip'], $data['country'], $data['ship_width'], $data['ship_length'], $data['ship_height'], $data['distance_unit'], $data['ship_weight'], $data['ship_mass_unit'], $data['tracking_number']
	...
	*/
	...
	function shipping_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function shipping_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function shipping_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function shipping_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function shipping_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function shipping_batch_actions(&$args){
