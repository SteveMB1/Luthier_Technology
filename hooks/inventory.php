<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'inventory' table. 
	...
	*/
	 ...
	 *     $data['item'], $data['status'], $data['description'], $data['item_cost'], $data['price_high'], $data['price_low'], $data['item_number'], $data['ref_listing'], $data['inventory_photo'], $data['location']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['item'], $data['status'], $data['description'], $data['item_cost'], $data['price_high'], $data['price_low'], $data['item_number'], $data['ref_listing'], $data['inventory_photo'], $data['last_update'], $data['location']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['item'], $data['status'], $data['description'], $data['item_cost'], $data['price_high'], $data['price_low'], $data['item_number'], $data['ref_listing'], $data['inventory_photo'], $data['location']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['item'], $data['status'], $data['description'], $data['item_cost'], $data['price_high'], $data['price_low'], $data['item_number'], $data['ref_listing'], $data['inventory_photo'], $data['last_update'], $data['location']
