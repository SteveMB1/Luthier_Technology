<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'acquisition' table. 
	...
	*/
	...
	function acquisition_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function acquisition_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function acquisition_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['call_back'], $data['seller_name'], $data['phone'], $data['purchase_notes'], $data['priority'], $data['location_city'], $data['location_state'], $data['pickup_date'], $data['pickup_time'], $data['street_address'], $data['category'], $data['ref_listing'], $data['photo_1'], $data['photo_2'], $data['photo_3'], $data['photo_4'], $data['photo_5'], $data['photo_6']
	...
	*/
	...
	function acquisition_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function acquisition_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['call_back'], $data['seller_name'], $data['phone'], $data['purchase_notes'], $data['priority'], $data['location_city'], $data['location_state'], $data['pickup_date'], $data['pickup_time'], $data['street_address'], $data['category'], $data['ref_listing'], $data['photo_1'], $data['photo_2'], $data['photo_3'], $data['photo_4'], $data['photo_5'], $data['photo_6']
	...
	*/
	...
	function acquisition_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function acquisition_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function acquisition_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function acquisition_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function acquisition_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function acquisition_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function acquisition_batch_actions(&$args){
