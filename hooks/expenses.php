<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'expenses' table. 
	...
	*/
	...
	function expenses_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function expenses_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function expenses_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['category'], $data['account'], $data['price'], $data['decription'], $data['date'], $data['from_account'], $data['account_detail'], $data['check_number'], $data['photo']
	...
	*/
	...
	function expenses_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function expenses_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['category'], $data['account'], $data['price'], $data['decription'], $data['date'], $data['from_account'], $data['account_detail'], $data['check_number'], $data['photo']
	...
	*/
	...
	function expenses_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function expenses_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function expenses_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function expenses_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function expenses_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function expenses_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function expenses_batch_actions(&$args){
