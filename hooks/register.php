<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'register' table. 
	...
	*/
	...
	function register_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function register_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function register_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['client_name'], $data['seller'], $data['phone'], $data['email']
	...
	*/
	...
	function register_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['client_name'], $data['seller'], $data['date'], $data['phone'], $data['email']
	...
	*/
	...
	function register_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['client_name'], $data['seller'], $data['phone'], $data['email']
	...
	*/
	...
	function register_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['client_name'], $data['seller'], $data['date'], $data['phone'], $data['email']
	...
	*/
	...
	function register_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function register_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function register_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function register_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function register_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function register_batch_actions(&$args){
