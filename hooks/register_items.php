<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'register_items' table. 
	...
	*/
	...
	function register_items_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function register_items_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function register_items_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['item_name'], $data['cost'], $data['ref_img']
	...
	*/
	...
	function register_items_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['previous_order'], $data['item_name'], $data['cost'], $data['ref_img']
	...
	*/
	...
	function register_items_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function register_items_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['previous_order'], $data['item_name'], $data['cost'], $data['ref_img']
	...
	*/
	...
	function register_items_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function register_items_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function register_items_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function register_items_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function register_items_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function register_items_batch_actions(&$args){
