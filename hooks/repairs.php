<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'repairs' table. 
	...
	*/
	...
	function repairs_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function repairs_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function repairs_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['repair_status'], $data['item'], $data['perform'], $data['repair_notes'], $data['cost'], $data['batch_number'], $data['photo_1'], $data['photo_2']
	...
	*/
	...
	function repairs_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['repair_status'], $data['item'], $data['perform'], $data['repair_notes'], $data['cost'], $data['batch_number'], $data['photo_1'], $data['photo_2'], $data['last_update']
	...
	*/
	...
	function repairs_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['repair_status'], $data['item'], $data['perform'], $data['repair_notes'], $data['cost'], $data['batch_number'], $data['photo_1'], $data['photo_2']
	...
	*/
	...
	function repairs_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['repair_status'], $data['item'], $data['perform'], $data['repair_notes'], $data['cost'], $data['batch_number'], $data['photo_1'], $data['photo_2'], $data['last_update']
	...
	*/
	...
	function repairs_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function repairs_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function repairs_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function repairs_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function repairs_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function repairs_batch_actions(&$args){
