<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'employees' table. 
	...
	*/
	 ...
	 *     $data['first'], $data['last'], $data['street_addr'], $data['city'], $data['state'], $data['hire_date'], $data['notes']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['first'], $data['last'], $data['street_addr'], $data['city'], $data['state'], $data['hire_date'], $data['notes'], $data['last_update']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['first'], $data['last'], $data['street_addr'], $data['city'], $data['state'], $data['hire_date'], $data['notes']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['first'], $data['last'], $data['street_addr'], $data['city'], $data['state'], $data['hire_date'], $data['notes'], $data['last_update']
