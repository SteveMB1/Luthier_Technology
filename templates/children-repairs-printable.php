			...
			<table class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][7]}"; ?> text-center" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][7]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo $Translation['ImageFolder'] . urlencode($record[7]); ?>" data-lightbox="repairs-photo_1"><img src="thumbnail.php?i=<?php echo urlencode($record[7]); ?>&t=repairs&f=photo_1&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][8]}"; ?> text-center" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][8]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo $Translation['ImageFolder'] . urlencode($record[8]); ?>" data-lightbox="repairs-photo_2"><img src="thumbnail.php?i=<?php echo urlencode($record[8]); ?>&t=repairs&f=photo_2&v=tv" class="img-thumbnail"></a></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
