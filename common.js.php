...
function acquisition_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#seller_name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Seller name", close: function(){ $j('[name=seller_name]').focus(); $j('[name=seller_name]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#phone').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Phone", close: function(){ $j('[name=phone]').focus(); $j('[name=phone]').parents('.form-group').addClass('has-error'); } }); return false; };
	if(!$j('[name=priority]:checked').length){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Purchase Priority", close: function(){ $j('[name=priority]').focus(); $j('[name=priority]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#category').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Category", close: function(){ $j('[name=category]').focus(); $j('[name=category]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function inventory_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function repairs_validateData(){
	$j('.has-error').removeClass('has-error');
	if(!$j('[name=repair_status]:checked').length){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Repair status", close: function(){ $j('[name=repair_status]').focus(); $j('[name=repair_status]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#batch_number').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Batch ID", close: function(){ $j('[name=batch_number]').focus(); $j('[name=batch_number]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function shipping_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#shipping_gateway').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Shipper", close: function(){ $j('[name=shipping_gateway]').focus(); $j('[name=shipping_gateway]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#street_address').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Street address", close: function(){ $j('[name=street_address]').focus(); $j('[name=street_address]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#city').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> City", close: function(){ $j('[name=city]').focus(); $j('[name=city]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#state').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> State", close: function(){ $j('[name=state]').focus(); $j('[name=state]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#zip').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Zip", close: function(){ $j('[name=zip]').focus(); $j('[name=zip]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#country').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Country", close: function(){ $j('[name=country]').focus(); $j('[name=country]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function register_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#client_name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Sold to", close: function(){ $j('[name=client_name]').focus(); $j('[name=client_name]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function expenses_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#category').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Category", close: function(){ $j('[name=category]').focus(); $j('[name=category]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#account').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Account / Person", close: function(){ $j('[name=account]').focus(); $j('[name=account]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#price').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Money", close: function(){ $j('[name=price]').focus(); $j('[name=price]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#from_account').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Account - Paid from", close: function(){ $j('[name=from_account]').focus(); $j('[name=from_account]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
...
function register_items_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
