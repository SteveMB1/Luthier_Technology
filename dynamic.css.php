...
.acquisition-phone{ white-space: normal !important; max-width: 86px !important; min-width: 86px !important; overflow: hidden;  }
.acquisition-location_city{ white-space: normal !important; max-width: 80px !important; min-width: 80px !important; overflow: hidden;  }
.acquisition-street_address{ white-space: normal !important; max-width: 80px !important; min-width: 80px !important; overflow: hidden;  }
.inventory-price_high{ white-space: normal !important; max-width: 70px !important; min-width: 70px !important; overflow: hidden;  }
.inventory-price_low{ white-space: normal !important; max-width: 70px !important; min-width: 70px !important; overflow: hidden;  }
.inventory-item_number{ white-space: normal !important; max-width: 150px !important; min-width: 150px !important; overflow: hidden;  }
.inventory-ref_listing{ white-space: normal !important; max-width: 120px !important; min-width: 120px !important; overflow: hidden; word-break: break-all; }
.inventory-inventory_photo{ white-space: normal !important; max-width: 150px !important; min-width: 150px !important; overflow: hidden;  }
.repairs-batch_number{ white-space: normal !important; max-width: 40px !important; min-width: 40px !important; overflow: hidden;  }
